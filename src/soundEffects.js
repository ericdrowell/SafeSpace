...
const SOUND_EFFECTS_NOVA_EXPLOSION =      function(){zzfx(1,.05,538,1,.09,1,4,2.06,0,-0.2,474,.04,0,.6,.1,.5,0,1,1,0)};
...
// zzfx(2.02,.05,147,0,.06,.05,0,.86,-8.7,0,0,0,0,.2,22,.3,.14,.84,.05,.12)
